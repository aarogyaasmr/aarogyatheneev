      ...
      <script>
        $(document).ready(function(){
          $("#getOrderReportForm").on('submit', function(e){
            ...
            // Optionally, you can show a loader or disable the button here
            ...
            $.ajax({
              ...
              success: function(response){
                // Insert the returned HTML into the report container
                $("#reportContainer").html(response);
              },
              error: function(xhr, status, error){
                $("#reportContainer").html("<p style='color:red;'>An error occurred: " + error + "</p>");
              }
            });
          });
        });
...
<!--  Author Name: Mayuri K. = www.mayurik.com for any PHP, Codeignitor or Laravel work contact me at mayuri.infospace@gmail.com  -->
