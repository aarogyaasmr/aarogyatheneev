...
<img src="assets/images/newlogo.png" alt="navbar logo">
</a>
...
<a href="./">
<img src="assets/images/newlogo.png" alt="sidebar logo" draggable="false">
</a>
</div>
<div class="xs-sidbar-getintouch">
<h6 class="mb-3">Get in Touch</h6>
<ul class="sideabr-list-widget">
<li> <i class="icon icon-location"></i> Pratibha Tower F356+6JR, Moti Vihar, Sector 41,</li>
<li><i class="icon icon-paper-plane"></i>  Gurugram, Haryana 122022</li>
<li> <i class="icon icon-phone-call"></i>+91 9315363694</li>
<li> <i class="icon icon-email"></i><a href="#" >aarogyawithbhumika@gmail.com</a></li>
</ul>
</div>
<div class="xs-instra-feed">
<p class="text-primary"><strong>@aarogya_with_bhumika</strong></p>
<!-- <ul>
...
<img src="assets/images/8227bhumikawebsite.png" alt="muscle man">
</div>
</div>
</div>
</div>
...
<section class="xs-section-padding xs-class-schedule-light parallaxie" data-scrollax-parent="true" id="schedule">
...
<div class="row">
<div class="col-lg-12">
<div class="table-responsive xs-schedule-table-light">
...
<section class="xs-section-padding-lg xs-bg-cover parallaxie" style="background-image: url(assets/images/8227bhumikawebsite.png)">
<div class="container">
...
<p>Yoga is especially beneficial in certain medical conditions typical to women. Six of these conditions are menopause, endometriosis, polycystic ovary syndrome (PCOS), uterine fibroids, premenstrual syndrome (PMS) and pregnancy.</p>
<ul class="xs-footer-contact-info">
<li>
<i class="icon icon-location"></i>
<p>
Pratibha Tower F356+6JR, Moti Vihar, Sector 41, Gurugram, Haryana 122022	</p>
</li>
<li>
<i class="icon icon-phone"></i>
<p>
<a class="xs-phone-number" href="tel:+65-094-778-622">+91 9315363694</a>
</p>
</li>
</ul>
</div>
...
<p>Copyright © 2024 Aarogya The Neev. All Rights Reserved</p>
</div>
<div class="col-md-6">
...
<!-- Mirrored from html.xpeedstudio.com/gemvast/onepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jan 2024 13:29:47 GMT -->
</html>