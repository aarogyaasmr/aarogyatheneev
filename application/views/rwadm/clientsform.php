        ...
        <label class="control-label col-md-4" for="name">Title <span class="required">*</span> </label>
			...
			if($home) {?>
                        ...
                        <?php }?>
                            ...
                            <div class="row form-group">
                    <label class="control-label col-md-4" for="name">Select Video </label>
                    <div class="col-md-8">
                      <select id="vidorimg" name="vidorimg" class="form-control">
                        <?php
			if($vidorimg) {?>
                        <option value="1" selected="selected">Yes</option>
                        <option value="0">No</option>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-md-8">
                      <input  class="form-control" name="videos"  type="text" value="<?php echo $videos; ?>">
                    </div>
                  </div>
                  <div class="row form-group">
