  ...
  <div class="card-body">
    <form class="form-horizontal form-label-left needs-validation" method="post" enctype="multipart/form-data" novalidate>
      <div class="row  form-group">
        <label class="control-label col-md-4" for="name">Selct Category <span class="required">*</span> </label>
        <div class="col-md-8">
          <div style="height: 100px; overflow-y: scroll">
            ...
            ?>
            <input type="checkbox" name="category[]" id="category" value="<?php echo $value['id']; ?>"  <?php echo $value['catchecked']; ?>/>
      ...
      <div class="row  form-group">
        <label class="control-label col-md-4" for="name">Video URL </label>
        <div class="col-md-8">
           <input id="videourl" class="form-control " name="videourl" required="required" type="text" value="<?php echo $videourl; ?>">
        </div>
      </div>
      <div class="row  form-group">
        <label class="control-label col-md-4" for="name">Sort Order</label>
        <div class="col-md-8">
          <input id="sortorder" class="form-control " name="sortorder"  type="text" value="<?php echo $sortorder; ?>">
        </div>
      </div>
