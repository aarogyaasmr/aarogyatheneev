...
<div class="card">
  <div class="card-body">
    <div class="button-list mb-2"> <a href="<?php echo base_url(adminpath.'/team/add'); ?>" class="btn btn-primary waves-effect waves-light text-white"> Add </a> <a onclick=" $('#teamform').attr('action', '<?php echo $deleteaction; ?>'); $('#teamform').submit();  " class="btn btn-danger waves-effect waves-light text-white"> Delete</a> <a onclick=" $('#teamform').attr('action', '<?php echo $activeaction; ?>'); $('#teamform').submit();  " class="btn btn-warning waves-effect waves-light text-white"> Active</a> <a onclick=" $('#teamform').attr('action', '<?php echo $inactiveaction; ?>'); $('#teamform').submit();  " class="btn btn-info waves-effect waves-light text-white">Inactive</a> </div>
