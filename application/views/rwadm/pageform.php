...
<div class="card">
  <div class="card-body">
    <form class="form-horizontal form-label-left needs-validation" method="post" enctype="multipart/form-data" novalidate>
      ...
      <div class="row  form-group">
        <label class="control-label col-md-4" for="name">Home Page Main Image bottom COntent  <span class="required">*</span> </label>
        <div class="col-md-8 ">
          <input id="iconasow" class="form-control" name="iconasow" required="required" type="text" value="<?php echo $iconasow; ?>">
        </div>
      </div>
      <div class="row  form-group">
      ...
      <div class="row  form-group">
        <label class="control-label col-md-4" for="description">Home Image </label>
        <div class="col-md-8 ">
          <input type='file' name='image' id="image" size='20' />
          <?php echo $image; ?> </div>
      </div>
      <div class="row  form-group">
        <label class="control-label col-md-4" for="description">Page Image </label>
        <div class="col-md-8 ">
          <input type='file' name='newimage' id="newimage" size='20' />
          <?php echo $newimage; ?> </div>
      </div>
      <div class="row  form-group">
      ...
      <div class="row  form-group">
        <label class="control-label col-md-4" for="description">Signature </label>
        <div class="col-md-8 ">
      ...
      <div class="row  form-group">
        ...
        <div class="col-md-8 ">
          <input type='file' name='pdf' id="pdf" size='20' />
          <?php echo $pdf; ?> </div>
      </div>
      <div class="row  form-group">
      ...
      <div class="row  form-group">
        ...
        <div class="col-md-8">
          <textarea id="homelist" name="homelist" class="form-control ckeditor"><?php echo $homelist; ?></textarea>
        </div>
      </div>
