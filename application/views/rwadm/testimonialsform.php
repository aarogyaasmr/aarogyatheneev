...
<div class="card">
  <div class="card-body">
    <form class="form-horizontal form-label-left needs-validation" method="post" enctype="multipart/form-data" novalidate>
      ...
      <div class="row  form-group">
        <label class="control-label col-md-4" for="name">Designation/Company <span class="required">*</span> </label>
        <div class="col-md-8">
      ...
      <div class="row  form-group">
        ...
        <div class="col-md-8">
          <textarea id="shortdescription" required="required" name="shortdescription" class="form-control"><?php echo $shortdescription; ?></textarea>
        </div>
      </div>
