          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <div class="pull-right"> <a href="<?php echo base_url(adminpath.'/pagesub'); ?>" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i> Back </a> </div>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
			...
			if($latest) {?>
                  ...
                  <div class="item form-group" style="display:none">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="linkname" class="form-control col-md-7 col-xs-12" name="linkname"  type="text" value="<?php echo $linkname; ?>">
                    </div>
                  </div>
                  <div class="item form-group" style="display:none">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mrpprice">MRP Price <span class="required">*</span> </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="mrpprice" class="form-control col-md-7 col-xs-12" name="mrpprice" type="text" value="<?php echo $mrpprice; ?>">
                    </div>
                  </div>
                  <div class="item form-group" style="display:none">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="price">Price <span class="required">*</span> </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="price" class="form-control col-md-7 col-xs-12" name="price"  type="text" value="<?php echo $price; ?>">
                    </div>
                  </div>
                  <div class="item form-group">
