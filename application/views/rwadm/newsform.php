...
<div class="card">
  <div class="card-body">
    <form class="form-horizontal form-label-left needs-validation" method="post" enctype="multipart/form-data" novalidate>
      ...
      <div class="row form-group">
        <label class="control-label col-md-4" for="author">Author <span class="required">*</span> </label>
        <div class="col-md-8">
      ...
      <div class="form-group row" style="display:none">
        ...
        <div class="col-md-8">
          <div class="input-group date form_date" data-date="" data-date-format="dd MM" data-link-field="dtp_input2" data-link-format="yyyy-mm">
            <input class="form-control" size="16" type="text" name="startdate" id="startdate" value="<?php echo $startdate; ?>" >
